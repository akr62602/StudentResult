...
try{
    ...
    ResultSet rs = st.executeQuery("SELECT * FROM studentResult INNER JOIN result ON studentResult.rollNo = result.rollNo WHERE studentResult.rollNo = '"+rollNo+"'");
    if(rs.next()){

%>

<img src="logo.png"  align="left"width="100" height="100">
<center><img src="aec.png"  width="150" height="150">
<img src=""></center>
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: Asansol Engineering College</th>
...
Designed & Developed by CSE Department</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Asansol Engineering College [ CSE Department ] :: 2020-2024</h6></center> 
  <hr class="new1">
</body>
<%
}
